...
export const NODE_TYPES: Record<string, NodeTypeDef> = {
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: "google/imagen-4.0-ultra-generate-001", label: "Imagen 4 Ultra (Google, deprecating)" },
          { value: "google/imagen-4.0-generate-001", label: "Imagen 4 (Google, deprecating)" },
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: "google/gemini-3.1-flash-image", label: "Nano Banana 2 (direct - temp via fal)" },
          { value: "google/gemini-3-pro-image-preview", label: "Nano Banana Pro (direct - temp via fal)" },
        ],
      },
    ],
    primaryField: "instructions",
  ...
  productScreenPlacement: {
    ...
    defaults: { device: "iphone16pro", background: "gradient-purple", headline_position: "top" },
    fields: [
      {
        name: "device",
        label: "Device frame",
        ...
        options: [
          ...
          { value: "galaxys24ultra", label: "Galaxy S24 Ultra" },
          { value: "pixel9pro", label: "Pixel 9 Pro" },
          { value: "pixel8pro", label: "Pixel 8 Pro" },
          { value: "ipadpro13", label: "iPad Pro 13-inch" },
          { value: "android", label: "Android (generic)" },
    ...
    fields: [
      {
        ...
        options: [
          { value: "google/gemini-3.1-flash-image", label: "Nano Banana 2 (direct - temp via fal) \u2b50" },
          { value: "google/gemini-3-pro-image-preview", label: "Nano Banana Pro (direct - temp via fal)" },
          { value: "openai/gpt-image-2", label: "GPT Image 2 (direct - temp via fal)" },
  ...
  topazVideo: {
    ...
    category: "video",
    icon: "clapperboard",
    description: "Professional video upscale, enhance, denoise and frame-interpolation (FPS) with Topaz Video AI on fal.",
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: "Artemis MQ", label: "Artemis MQ" },
          { value: "Artemis LQ", label: "Artemis LQ" },
          { value: "Nyx", label: "Nyx (denoise)" },
          { value: "Nyx Fast", label: "Nyx Fast" },
          { value: "Nyx XL", label: "Nyx XL" },
          { value: "Nyx HF", label: "Nyx HF" },
          { value: "Gaia HQ", label: "Gaia HQ (AI/CG/anim)" },
          { value: "Gaia CG", label: "Gaia CG (AI/CG/anim)" },
          { value: "Starlight Precise 1", label: "Starlight Precise 1 (diffusion)" },
          { value: "Starlight Precise 2", label: "Starlight Precise 2" },
          { value: "Starlight Precise 2.5", label: "Starlight Precise 2.5" },
          { value: "Starlight HQ", label: "Starlight HQ" },
          { value: "Starlight Mini", label: "Starlight Mini" },
          { value: "Starlight Sharp", label: "Starlight Sharp" },
          { value: "Starlight Fast 1", label: "Starlight Fast 1" },
  ...
  topazImage: {
    ...
    category: "image",
    icon: "wand-sparkles",
    description: "Professional image upscale and enhancement with Topaz on fal (face enhance, denoise, sharpen, compression fix, generative).",
    inputs: [{ name: "image", type: "image" }],
    outputs: [{ name: "image", type: "image" }],
    defaults: {
      model: "Standard V2",
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: "CGI", label: "CGI (rendered/anim)" },
          { value: "Text Refine", label: "Text Refine (UI/text)" },
          { value: "Recovery", label: "Recovery" },
          { value: "Recovery V2", label: "Recovery V2" },
          { value: "Redefine", label: "Redefine (generative)" },
  ...
  hook: {
    ...
    inputs: [
      { name: "video", type: "video", optional: true, multi: true },
      { name: "image", type: "image", optional: true, multi: true },
      { name: "audio", type: "audio", optional: true, multi: true },
      { name: "text", type: "text", optional: true, multi: true },
    ],
  ...
  composer: {
    ...
    outputs: [{ name: "video", type: "video", label: "Export" }],
    defaults: { exportUrl: "" },
    fields: [],
    custom: "composer",
  },
