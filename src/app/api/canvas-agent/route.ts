...
ROUTING TEXT CHUNKS: to send DIFFERENT pieces of one text (a script, a competitor breakdown, a hooks list) to DIFFERENT generators, add a textSplit node - wire the source text into its "text" input, then wire its part1/part2/part3... outputs into separate generator prompt/text inputs. Prefer mode "auto" with a clear split instruction; use numbered/delimiter/lines for explicit formats.
